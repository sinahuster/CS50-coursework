...
db.execute("CREATE TABLE house_assignements(student_id INTEGER, house_id INTEGER,
           FORGEIN KEY(student_id) REFERENCES student(id), FORGEIN KEY(house_id) REFERENCES houses(id)))
